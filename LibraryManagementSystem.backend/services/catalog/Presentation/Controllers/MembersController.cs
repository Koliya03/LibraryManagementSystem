...
namespace Presentation.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        public async Task<ActionResult<MemberResponseDto>> GetById(Guid memberId)
        {
            MemberResponseDto result = await _bus.InvokeAsync<MemberResponseDto>(new GetMemberByIdQuery(memberId));
