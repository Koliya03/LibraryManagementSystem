...
namespace Presentation.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        {
            BookResponseDto result = await _bus.InvokeAsync<BookResponseDto>(new GetBookByIdQuery(bookId));
        ...
        [HttpPost]
        public async Task<IActionResult> RegisterBook([FromBody] RegisterBookCommand dto)
        {
            await _bus.InvokeAsync(dto);
        ...
        {
            await _bus.InvokeAsync(new BorrowBooksCommand(id));
